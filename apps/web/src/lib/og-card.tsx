...
/**
 * The share card, rendered once and used by every route that needs one.
 *
 * One pipeline, two jobs: the same 1200x630 PNG is what a link unfurls to in a
 * chat window and what the hover preview shows before the reader commits to a
 * click. Building a second image pipeline for the previews would mean two
 * places to keep in step and two things to go stale.
 *
    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
          ...
          <div style={{ display: "flex", fontSize: 30, letterSpacing: "-0.01em" }}>husk</div>
          {eyebrow ? (
            <div
              style={{
                display: "flex",
